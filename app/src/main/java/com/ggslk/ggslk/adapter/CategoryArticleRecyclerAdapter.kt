...
class CategoryArticleRecyclerAdapter(private val context: Context, private val articles: List<Article>) : RecyclerView.Adapter<CategoryArticleRecyclerAdapter.ArticleViewHolder>() {
